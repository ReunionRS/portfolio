document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    ru: {
      ...
      project_open: "Открыть сайт",
      project_rustore: "RuStore",
      project_source: "Исходный код",
      p1_title: "VPRussia",
      ...
      p3_title: "SmartHouse / Lumen",
      p3_sub: "Flutter-приложение для управления умным домом",
      p3_desc: "Мобильный Flutter-клиент и Node.js/Express API для управления объектами, устройствами и системами умного дома.",
    ...
    en: {
      ...
      p3_title: "SmartHouse / Lumen",
      p3_sub: "Flutter app for smart home management",
      p3_desc: "A mobile Flutter client and Node.js/Express API for managing properties, devices and smart home systems.",
